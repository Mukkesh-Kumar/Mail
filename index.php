  ...
  try {
    ...
    if ($result[0]["count"] > 0) {
      ...
      if ($result > 0) {
        ...
        $message .= '<p><a href="activate.php?id=' . base64_encode($lastID) . '">CLICK TO ACTIVATE YOUR ACCOUNT</a>';
        $message .= "</body></html>";
        ...
        $mail->Username = 'mukesh@fixnix.co';
        $mail->Password = '3752625M';

        $mail->SetFrom('mukesh327kumar@gmail.com', 'Mukkesh Kumar M');
